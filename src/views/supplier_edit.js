...
var nominee_relation= data1[0].nominee_relation;   	
		...
		document.getElementsByClassName("area_of_experience_edit")[0].innerHTML=html;
...
/>,
 	document.getElementsByClassName("area_of_experience_edit")[0]
);
        ...
        <div class='col-md-6'>
          ...
          <b> Year of Establishment:</b><span class='required'></span>
              ...
              <b> Major Supply Line:</b><span class='required'></span>
                 <div id=''    class='area_of_experience_edit' ></div>
        </div>
