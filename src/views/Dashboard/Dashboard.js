...
import '../../views/Account/design.css'
...
class Dashboard extends Component {
  ...
  handlebutton(event) {
    ...
    axios
      .post(url.server_url + "/get_supplier_count  ", article)
      .then((data) => {
    ...
    axios
      .post(url.server_url + "/get_hotel_owner_count  ", article)
      .then((data) => {
        var status_code = data.data.status_code;
        var result = data.data.data;
        if (status_code == 200) {
    ...
    axios
      .post(url.server_url + "/get_employee_count  ", article)
      .then((data) => {
        var status_code = data.data.status_code;
        var result = data.data.data;
    ...
    axios.post(url.server_url + "/get_vender_count  ", article).then((data) => {
      var status_code = data.data.status_code;
      var result = data.data.data;
      if (status_code == 200) {
        this.setState({
  ...
  componentDidMount() {
    ...
    fetch(url.server_url + "/get_hotel_owner_count", requestOptions)
      ...
      .then((data) => {
        ...
        if (status_code == 200) {
          this.setState({
            hotelCount: countData,
          });
        }
      });

    // employee
    fetch(url.server_url + "/get_employee_count", requestOptions)
      .then((response) => response.json())
      .then((data) => {
        var status_code = data.status_code;
        ...
        if (status_code == 200) {
          this.setState({
            employeeCount: countData,
          });
        }
      });
    // vender
    fetch(url.server_url + "/get_vender_count", requestOptions)
      .then((response) => response.json())
      .then((data) => {
        var status_code = data.status_code;
        var countData = data.data;
        if (status_code == 200) {
          this.setState({
            venderCount: countData,
          });
        }
      });
    // supplier
    fetch(url.server_url + "/get_supplier_count", requestOptions)
      .then((response) => response.json())
      .then((data) => {
        var status_code = data.status_code;
        var result = data.data;
        if (status_code == 200) {
          // $(".date").html(result[0].created_on)
          this.setState({
            supplierCount: result.length,
            // supplierdate: result[0].created_on,
          });
        }
      });
  }
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-info">
              <CardBody className="pb-0">
                ...
                <div className="text-value">{this.state.hotelCount}</div>
                <div>{this.state.hoteldate}</div>
                <div>Hotel Owner</div>
              </CardBody>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                ...
                <div className="text-value"> {this.state.employeeCount}</div>
                <div>{this.state.employeedate}</div>
                <div>Employee</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: "70px" }}>
                <Line
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-warning">
              <CardBody className="pb-0">
                ...
                <div className="text-value">{this.state.venderCount}</div>
                <div>{this.state.venderdate}</div>
                <div>Vender</div>
              </CardBody>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-danger">
              <CardBody className="pb-0">
                ...
                <div className="text-value">{this.state.supplierCount}</div>
                <div>{this.state.supplierdate}</div>
                <div>Supplier</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: "70px" }}>
                <Bar
