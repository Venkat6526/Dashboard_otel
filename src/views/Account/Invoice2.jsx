...
$("body").on("change",".make_approved",function(){
  ...
  var v=$(this).val()
  $.ajax({
    url:url.server_url+apinames.make_approved2,
    data:{id:id,v:v},
    type:"POST",
    dataType:"JSON",
...
$("#send_whatsapp").off('click').on("click",function(e){
  ...
  const getTotalInfo = (add) => {
    ...
    // let gsttotal = parseFloat(add.grandtotal * gstValue) / 2;
    let subtotal = parseFloat(add.grandtotal);
    let grtotal = subtotal ;
  ...
  const getTotalInfo2 = (add) => {
    ...
    setSubTotal2(subTotal + subtotal);
    // setTaxTotal(taxTotal + gsttotal);
    setGrandTotal2(grandTotal + grtotal);
  };
  ...
  //     // let gsttotal = parseFloat(i.rate) * parseFloat(i.qty) ;
        ...
        <>
          ...
          >
            ...
            ></i>
               ...
               <a  href={url.pdf_url+`/pdf_invoice2.php?id=${row.main.id}`}>
          ...
          <button
            className="btn btn-primary send_whatsapp"
           value={row.main.id}
          >
           Whatsapp
          </button>&nbsp;
          <a
            ...
            href={`#/Merge/${row.main.customer_id}-${row.main.id}`}
  ...
  useEffect(() => {
    $("body").on("click",".send_whatsapp",function(e){
      ...
      var id=$(this).val()
      $.ajax({
          "url":url.whatsapp_url+"/send_whatsapp2.php",
          data:{id:id},
          type:"POST",
          dataType:"json",
          success:function(data){
  ...
  useEffect(() => {
    getAPI(apinames.GET_INVOICE2)
      ...
      postAPI(apinames.GET_INVOICE2_PENDING,{created_by:created_by})
      .then((response) => {
  ...
  const onsubmit = (data) => {
    ...
    postAPI(apinames.POST_INVOICE2, postData)
      .then((response) => {
  ...
  const onsubmit3 = (data2) => {
    ...
    postAPI(apinames.PUT_INVOICE2, editData1)
      .then((response) => {
        var status_code = response.status_code;
        let alert_data;
  ...
  const handleDelivery = () => {
    ...
    getAPI(apinames.PUT_DELIVERY + eedit+"<>"+check_delivered+"<>invoice_main2").then((response) => {
      var status_code = response.status_code;
      if (status_code == 200) {
         window.location.reload();
      }
              ...
              >
                ...
                <div className="col-md-3">
                  <div className="delivery">
                    ...
                    <input  min={0}  type="number" {...register("mobile_no2_a")} tabIndex="4" />
                    <br />
                    <br />
                    <label>
                ...
                <div className="col-md-3">
                  <div className="details">
                    ...
                    <br />
                    <select className="Bank" {...register("dispatch_through")} tabIndex="17">
                      <option value="select">Select</option>
                    ...
                    <br />
                    <select className="uom" {...register("dispatch_from")} tabIndex="18">
                      <option value="select">Select</option>
                ...
                <table className="table  table-bordered">
                  <thead>
                    ...
                    <tr>
                      ...
                      <button type="button" className="btn btn-outline-warning ps-3 pe-3 mt-3 ms-2 mb-3" onClick={addUpdate}>
                        Add
                      </button>
                    </tr>
                  ...
                  >
                    ...
                    <div className="col-md-3">
                      <div className="ref-3">
                        ...
                        <br />
                        <select className="Market" {...register3("marketing_type")}>
