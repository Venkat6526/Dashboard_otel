      ...
      <div>
        <Modal show={show} onHide={close}>
          <Modal.Header closeButton style={{ backgroundColor: "aliceblue" }}>
            <Modal.Title style={{marginLeft:"20px"}}>Add Stocks</Modal.Title>
          </Modal.Header>
          <Modal.Body style={{ backgroundColor: "aliceblue" }}>
            <div>
              <form key={1} className="ms-5" onSubmit={handleSubmit(onSubmit)}>
                <table >
                  <tbody>
                    <tr>
                      <th className="me-5">Date:</th>
                      <td>
                        {" "}
                        <input type="date" {...register("date")} className="date ms-5"/> <br />
                    ...
                    <br />
                    <tr>
                      <th className="me-5">QTY:</th>
                      <td >
                        <input type="number" min={0} {...register("qty")} className=" ms-5"/>{" "}
                        <br />
                        <span className="text-danger">
                    ...
                    <tr>
                      <th className="me-5"> Financial Year : <span>{" "}</span></th> 
                      <td>
                        <select  className="Bank ms-5" {...register("financial_year")}>
