...
export default function Purchase() {
  ...
  const handleClose = () => {setShow2(false);  setShow3(false);}
...
$("body").off("click").on("click","#send_whatsapp3",function(e){
              ...
              >
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <select value={values.state} className="state" {...register("state")}>
                ...
                <table className="table  table-bordered">
                    ...
                    <tr>
                      ...
                      <button
                        ...
                        onClick={addUpdate}
                        style={{ float: "center" , marginLeft:"20px" , marginRight:"20px" }}
                      >
                        Add
                      </button>
                    </tr>
