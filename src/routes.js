...
const Users = React.lazy(() =>
  import("./views/Account/Users.jsx")
);
const Accessebility = React.lazy(() =>
  import("./views/Account/Accessebility.jsx")
);
// settings
...
const Merge = React.lazy(() =>
  import("./views/Account/Merge.jsx")
);
const RoleAccessebility = React.lazy(() => import("./views/Account/RoleAccessebility.jsx"));
...
const routes = [
  ...
  { path: "/PerformaInvoice", name: "Proforma Invoice", component: PerformaInvoice },
  { path: "/Users", name: "Users", component: Users },
  { path: "/Accessebility", name: "Accessebility", component: Accessebility },
  { path: "/RoleAccessebility", name: "Roles", component: RoleAccessebility },
  { path: "/Merge", name: "Merge", component: Merge },
];
