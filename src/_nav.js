...
var id=localStorage.getItem("ootel_admin_created_by")
...
if(role=="admin"){
  ...
  var jqxhr = $.ajax({
    type: "POST",
    url: url.server_url+"/get_user_accessebility",
    data: {id:id},
    dataType: 'json',
    //cache: false,
    async: false,
  ...
  let m=JSON.parse(jqxhr.responseText);
  exported_menu={items:m.data} 

}

//alert(JSON.stringify(exported_menu))

export default exported_menu;