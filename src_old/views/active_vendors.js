...
import { Photo_details } from "./photo_gallery.js";
import { Basic_details } from "./profile_template.js";
import { act } from "react-test-renderer";
import Vendor_edit from "./vendor_edit.js";
import { Accept_payment } from "./accept_payment_vendors.js";
import { func } from "prop-types";
import { ExportReactCSV } from "./exportexcel/ExportReactCSV.js";
          ...
          for (var i = 0; i < data.length; i++) {
            return_data.push({
              ...
              action:
                ...
                "     <button class='btn btn-primary edit_profile_vendor' value='" +
                data[i].id +
...
class Table extends React.Component {
  ...
  componentDidMount() {
    ...
    $("#table").on("click", ".edit_profile_vendor", function () {
      try {
    ...
    document.querySelector("#table").addEventListener(
      ...
      $.ajax({
        url: url.server_url + "/get_package_vendors",
        type: "POST",
          ...
          <table className="table table-striped table-bordered" id="table">
            <thead style={{ background: "lightsteelblue" }}>
              <tr>
                ...
                <th>Business name</th>
                <th>Mobile</th>
                <th style={{ width: "96px" }}>Profile</th>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <div
              ...
              style={{ marginLeft: "150px", marginTop: "-23px" }}
            ></div>
          </div>
        </div>
