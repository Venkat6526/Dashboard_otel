    ...
    try {
      ...
      document
        ...
        .addEventListener("click", function (e) {
          ...
          var service_providers = document.querySelector("#service_providers")
            .checked;
          try {
            if (
              content == "" ||
  ...
  componentDidMount() {
    ...
    document.querySelector("#table").addEventListener("click", function (e) {
      ...
      if (id != null && action == "edit") {
        ...
        document.querySelector("#content1").value = e.target.getAttribute(
          "content"
        );
                  ...
                  buttons: [
                    {
                      ...
                      onClick: () => {
                        ...
                        const rawResponse = fetch(url.server_url + "/delete_announcementdetails", {
                          method: "POST",
                          headers: {
                            "Content-Type": "application/json",
                          },
    ...
    document.querySelector("#btnedit").addEventListener("click", function (e) {
      ...
      var service_providers = document.querySelector("#service_providers1")
        .checked;
      try {
        if (
          content == "" ||
