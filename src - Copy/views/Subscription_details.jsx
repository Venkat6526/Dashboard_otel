...
import '../../src/views/Account/design.css'
      ...
      <Tab eventKey={1} title="Subscripition">
        <div>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <label>Member:</label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <select className="uom" {...register("member")}>
            ...
            <label>Type:</label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <select className="uom" {...register("type")}>
              <option value="select">select</option>
        ...
        <div>
          ...
          <div>
            <Modal show={open} onHide={editClose}>
              ...
              <Modal.Body>
                <div>
                  <form className="ps-5" onSubmit={handleSubmit2(EditSubmit)}>
                    <label className="ms-5">Package:</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" className="form-control edit w-25" {...register2("package")} />
                    <br />
                    <span className="text-danger" style={{paddingLeft:"5px"}}>
                      {errors2.package && errors2.package.message}
                    </span>
                    <label className="ms-5">Member:</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select  className="form-control edit w-25" {...register2("member")}>
                      <option value="select">select</option>
                      <option value="Supplier">Supplier</option>
                      <option value="Hotel_Owner">Hotel Owner</option>
                      <option value="Vendor">Vendor</option>
                    ...
                    <br />
                    <label className="ms-5">Type:</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select  className="form-control edit w-25" {...register2("type")}>
                      <option value="select">select</option>
                      <option value="free">---Free---</option>
                      <option value="paid">---Paid---</option>
                    </select>
                    ...
                    <br />
                    <label className="ms-5">Duration(Days):</label>&nbsp;
                    <input type="number"  className="form-control edit w-25" {...register2("duration")}  min={0}/>
                    <span className="text-danger">
                      {errors2.duration && errors2.duration.message}
                    </span>
                    <br />
                    <label className="ms-5">Cost:</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="number"  className="form-control edit w-25" {...register2("cost")} />
                    <span className="text-danger">
                      {errors2.cost && errors2.cost.message}
                    </span>
                    <br />
                    <button type="submit" className="btn btn-primary" style={{marginLeft:"120px"}}>
                      Save
                    </button>
                  </form>
                </div>
