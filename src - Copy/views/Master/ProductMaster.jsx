...
import FunctionAlert from "../alert/ProductMasterAlert";
      ...
      .then((response) => {
        ...
        if (status_code == 200) {
          ...
          alert_data = {
            code: status_code,
            title: `{postData}`,
            data: "ADDED NEW PRODUCT Submitted Successfully",
          };
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        >
                          ...
                          <option value="kg" className="uom">
                            KG
                          </option>
                          <option value="gram" className="uom">
                            Gram
                          </option>
                          <option value="rolls" className="uom">
                            Rolls
                          </option>
                          <option value="number" className="uom">
                            Number
                          </option>
                          <option value="pieces" className="uom">
                            Pieces
                          </option>
                          <option value="box" className="uom">
                            Box
                          </option>
                        </select>
