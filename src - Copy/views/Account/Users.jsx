            ...
            <div  className="col-md-6">
              <table>
                <tbody>
                  ...
                  <option value="select" >Select</option>
                   {hierarchy_id.map((data, index) => (
                    <>
                    <option value="CEO" className="add">{data.name}</option>
                ...
                <label>Mobile No:</label>
                    <br/>
                <input type="number" name="Mobile_No" {...register("Mobile_No")}  />
                <br/>
            ...
            <div className="col-md-6">
              <Table striped bordered hover>
                <tbody>
                  ...
                  <label>Mobile No:</label>
                      <br/>
                  <input type="number" name="another_mobile" defaultValue={values.another_mobile} {...register2("another_mobile")}  />
                  <br/>
