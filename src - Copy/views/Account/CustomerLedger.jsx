...
export default function CustomerLedger() {
  ...
  const [from_date, set_from_date] = useState(0);
  const [to_date, set_to_date] = useState(0);
        ...
        >
          ...
          <Modal.Body>
              ...
              <form key={1} onSubmit={handleSubmit(onSubmit)}>
                <table>
                  <tr>
                    <td>From :</td>
                    <td>
                      <input type="date" {...register("fromDate")} className="date ms-1 me-3" id="from_date"/>
                    ...
                    <td>To :</td>
                    <td>
                      <input type="date" {...register("toDate")} className="ms-1 me-3 date"  id="to_date"/>
                      <span className="text-danger">
            ...
            <DataTable
              ...
              // selectRowsHighlight
              highlightOnHover
              actions={<a href={url.pdf_url+"/customer_ledger.php?id="+customer_id+"&from_date="+from_date+"&to_date="+to_date}><button className="btn btn-primary">PDF</button></a>}
              subHeader
            />
          </Modal.Body>
        </Modal>
