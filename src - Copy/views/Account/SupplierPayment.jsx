          ...
          <div className="row">
            <div className="col-md-6">
              <table>
                <tbody>
                  <tr>
                    <td style={{paddingBottom:"5px"}}>Supplier Name:</td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <select className="Bank"{...register("payment_bank")}>
          ...
          <DataTable
            ...
            subHeaderComponent={
              <Filter
                ...
                className="w-25 date form-control mb-3"
            ...
            <Modal.Body>
              <div>
                <form onSubmit={handleSubmit2(onSubmit2)}>
                  ...
                  <input
                    type="date"
                    className="form-control date edit w-25"
                  ...
                  <label className="me-5">Payment Mode:</label>
                  ...
                  <span className="ms-1 me-2">Cash</span>
                  <input
                    type="radio"
                    id="radio"
                    value="cheque"
                  ...
                  />
                  <span>{errors2.pay_mode && errors2.pay_mode.message}</span>
                  <span className="ms-1 me-2">Cheque</span>
                  <input
                    type="radio"
                    id="radio"
                    value="online"
                  ...
                  <span>{errors2.pay_mode && errors2.pay_mode.message}</span>
                  <span className="ms-1 me-2">Online</span>
                   <br/><br />
                  <label className="mt-2">Payment Description:</label>
                  ...
                  <br/>
                  <label className="mt-1">Payment Bank:</label>
                 
                  <select className="btn btn-outline-dark edit1 mt-1" {...register2("payment_bank")}>
                    <option value="select">Select</option>
                    <option value="hdfc bank">HDFC Bank</option>
                    <option value="icici bank">ICICI Bank</option>
                  </select>
